...
(function () {
  ...
  function creditTutor(source) {
    var el = $("tutor-credit");
    el.hidden = false;
    el.textContent = source === "ai"
      ? "Remediation generated by Nemotron 3 Super via NVIDIA NIM. Verify clinical details against your course references."
      : "Remediation drawn from the built-in item notes (AI tutor unavailable).";
  }
