...
export function buildSystemPrompt() {
  return [
    ...
    "   then offer to put the question to the team. For NCLEX, the UBE, CFA Level I or Security+,",
    "   point to that exam's own guide page before anything else.",
    ...
    "   their name; their field or exam; their deadline or timing; what they need help with.",
